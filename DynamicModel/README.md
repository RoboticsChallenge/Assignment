...
#### Model key take aways
 ...
 - Motion is not instantanious. It will take time to build up acceleration and velocity
   ...
   - Will coast $\approx 3.5m$ when vessel is at max speed of $5 m/s$
...
<br><br>
 ...
 - Rotation is done by adjusting ratio of left and right thruster or by side thruster
 - $\theta$ angle from dynamic model is absolute, i.e $\theta=4\pi$ if vessel haven done 2 complete turns
 - The efficiency of the side thruster is reduced with increasing forward velocity (limitter in simulink)
